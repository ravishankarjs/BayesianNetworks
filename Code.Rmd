...
columns_for_csv <- c("Crash.Date.Time","Collision.Type","Weather","Surface.Condition","Light","Injury.Severity","Driver.Distracted.By","Speed.Limit","Vehicle.Movement","Speed.Limit")
...
weather_data <- read.csv("montgomery_data.csv",header=TRUE)
...
factor_variables <- c("Collision.Type", "Weather", "Surface.Condition", "Light", "Injury.Severity", "Driver.Distracted.By", "Speed.Limit", "Vehicle.Movement")
...
summary(crash_data[, c("tempmax", "tempmin", "temp", "humidity", "windgust", "windspeed", "cloudcover", "visibility", "uvindex")])

# Summary statistics for categorical variables
summary(crash_data[, c("Collision.Type", "Weather", "Surface.Condition", "Light", "Injury.Severity", "Driver.Distracted.By", "Speed.Limit", "Vehicle.Movement")])

# Histograms for temperature-related variables
par(mfrow = c(4, 2))
hist(crash_data$temp, main = "Histogram of Temperature", xlab = "Temperature")
hist(crash_data$humidity, main = "Histogram of Humidity", xlab = "Humidity")
hist(crash_data$windspeed, main = "Histogram of WindSpeed", xlab = "Wind speed")
hist(crash_data$visibility, main = "Histogram of Visibility", xlab = "Visibility")
hist(crash_data$uvindex, main = "Histogram of UVIndex", xlab = "UV Index")
hist(crash_data$cloudcover, main = "Histogram of CloudCover", xlab = "Cloud Cover")

# Bar plots for categorical variables
par(mfrow = c(4, 2))
barplot(table(crash_data$Collision.Type), main = "Collision Type", col = "lightcoral")
barplot(table(crash_data$Weather), main = "Weather", col = "violet")
barplot(table(crash_data$Surface.Condition), main = "Surface Condition", col = "green")
barplot(table(crash_data$Light), main = "Light Condition", col = "lightblue")
barplot(table(crash_data$Injury.Severity), main = "Injury Severity", col = "lightgray")
barplot(table(crash_data$Driver.Distracted.By), main = "Driver Distracted By", col = "lightpink")
barplot(table(crash_data$Speed.Limit), main = "Speed Limit", col = "cyan")

# Compute Pearson correlation coefficients
correlation_matrix <- cor(crash_data[, c("tempmax", "tempmin", "temp", "humidity", "windgust", "windspeed", "cloudcover", "visibility", "uvindex")], method = "pearson")

# Compute Spearman correlations
spearman_correlation_matrix <- cor(crash_data[, c("tempmax", "tempmin", "temp", "humidity", "windgust", "windspeed", "cloudcover", "visibility", "uvindex")], method = "spearman")

# Visualize correlation matrices
par(mfrow = c(1, 2))
corrplot(cor(crash_data[, c("tempmax", "tempmin", "temp", "humidity", "windgust", "windspeed", "cloudcover", "visibility", "uvindex")], method = "pearson"), 
         method = "color", type = "upper", order = "hclust", tl.col = "black", tl.srt = 90, main = "Pearson Correlation Matrix")
corrplot(cor(crash_data[, c("tempmax", "tempmin", "temp", "humidity", "windgust", "windspeed", "cloudcover", "visibility", "uvindex")], method = "spearman"),
         method = "color", type = "upper", order = "hclust", tl.col = "black", tl.srt = 90, main = "Spearman Correlation Matrix")

# Write data to CSV file
write_csv(crash_data, "crash_data_subset.csv")
...
# 5. Bayesian Dirichlet equivalent uniform (BDeu) score-based algorithm
bdeu_bn <- hc(crash_data_discrete, score = "bde")

# Plot the learned Bayesian network structures
par(mfrow = c(2, 2), mar = c(2, 2, 2, 2), oma = c(2, 2, 2, 2))

plot(hc_bn, main = "Hill-Climbing", edge.label.cex = 0.8, node.label.cex = 0.8)
plot(tabu_bn, main = "Tabu", edge.label.cex = 0.8, node.label.cex = 0.8)
plot(mmhc_bn, main = "MMHC", edge.label.cex = 0.8, node.label.cex = 0.8)
plot(hpc_bn, main = "HPC", edge.label.cex = 0.8, node.label.cex = 0.8)
...
# Example queries using the Hill-Climbing network
...
# Discuss the relationships between variables found in the Bayesian network
# (Provide a clear discussion in the report based on the obtained network)
